...
public class ExampleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnToast = (Button) rootView.findViewById(R.id.btn_action_toast_fragment_1);
        ...
        Button btnGoToFragment2 = (Button) rootView.findViewById(R.id.btn_action_go_to_fragment_2);
        btnGoToFragment2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.container, new ExampleFragment2());
